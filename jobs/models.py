...
class Job(models.Model):
    ...
    experience = models.CharField(default='', max_length=50, verbose_name='经验')
    worktype = models.CharField(default='', max_length=50, verbose_name='工作性质')
    education = models.CharField(default='', max_length=50, verbose_name='学历')
    ...
    company_shortname = models.CharField(default='', max_length=50, verbose_name='公司名称')
    ...
    industry_area = models.CharField(default='', max_length=50, verbose_name='行业领域')
